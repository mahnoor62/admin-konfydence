...
export default function Newsletter() {
  ...
  const fetchSubscribers = async () => {
    try {
      ...
      const response = await api.get('/newsletter/list', {
        params: {
          page,
          limit: 50,
      ...
      setError(err.response?.data?.message || 'Failed to fetch newsletter subscribers');
    } finally {
      setLoading(false);
    }
  };
    ...
    <Box sx={{ p: 3 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Manage and view all newsletter email subscriptions
        </Typography>
      </Box>
